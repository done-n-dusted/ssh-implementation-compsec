...
int client_authenticate( int sock, unsigned char **session_key )
{
	...
	*/
    ...
    printBuffer("Buffer content after SERVER_INIT_RESPONSE: ", pubkeyc, initResponse.length);
	...
	*/
    ...
    printBuffer("Buffer content after SERVER_INIT_ACK: ", message, msg_len);
...
/*
	...
	*/
    ...
    // printf("Buffer content after CLIENT_INIT_ACK: ");
    printBuffer("Buffer content after CLIENT_INIT_ACK: ", symKeyBuffer, initAck.length);
    fflush(stdout);
	...
	*/
	...
	// Print buffer content
    // printf("Buffer content after encryption: ");
    printBuffer("Buffer content after encryption: ", buffer, len);
    fflush(stdout);
